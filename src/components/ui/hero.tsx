      ...
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <text className="text-[11px] font-black tracking-[0.18em] uppercase" fill="black">
          <textPath href="#circlePath" startOffset="0%">
            SOVEREIGN • ELITE • NEXUS • SOVEREIGN • 
          </textPath>
        </text>
      </svg>
    </div>
...
export const Hero = () => {
  return (
    <div className="min-h-screen bg-[#0038FF] flex flex-col font-sans selection:bg-[#CCFF00] selection:text-black relative overflow-hidden w-full">
      ...
      {/* Navbar */}
      <nav className="relative z-20 flex items-center justify-between px-6 py-6 md:px-10 md:py-8 max-w-[1440px] mx-auto w-full text-white">
        <div className="flex items-center gap-1">
          <div className="bg-white text-black font-black tracking-tight text-xs md:text-sm px-3 py-1.5 rounded-2xl rounded-bl-sm relative shadow-sm uppercase">
            SKILLS
            <div className="absolute -bottom-1.5 left-0 w-3 h-3 bg-white" style={{ clipPath: 'polygon(0 0, 100% 0, 0 100%)' }}></div>
          </div>
          <div className="bg-[#CCFF00] text-black font-black text-xs md:text-sm px-3 py-1.5 rounded-full border-[1.5px] border-white shadow-sm uppercase">
            NEXUS
          </div>
        </div>

        <div className="hidden md:flex items-center space-x-2">
          {['Domain Suites', 'Skill Scout', 'Health Pulse', 'Audit Protocol'].map((item) => (
          ...
          <div className="absolute inset-0 w-full h-full pointer-events-none text-white">
            ...
            >
              <div className="w-40 md:w-52 aspect-[3/3.5] bg-white/20 backdrop-blur-md border border-white/40 rounded-[2rem] p-5 flex flex-col items-center justify-center rotate-[-12deg] shadow-2xl hover:rotate-0 transition-transform duration-500">
                ...
                <div className="text-center mt-2">
                  <p className="font-bold text-sm md:text-lg text-white">sovereign.agent</p>
                  <p className="text-[10px] md:text-xs text-white/80 mt-1">Intelligence Rank: 01</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="w-40 md:w-52 aspect-[3/3.5] bg-white/20 backdrop-blur-md border border-white/40 rounded-[2rem] p-5 flex flex-col items-center justify-center rotate-[12deg] shadow-2xl hover:rotate-0 transition-transform duration-500">
                ...
                <div className="text-center mt-2">
                  <p className="font-bold text-sm md:text-lg text-white">nexus.core</p>
                  <p className="text-[10px] md:text-xs text-white/80 mt-1">363 Skills Audited</p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="bg-white text-black rounded-t-[2.5rem] md:rounded-t-[3.5rem] px-6 py-12 md:px-10 md:py-16 relative z-20 shadow-[0_-20px_50px_rgba(0,0,0,0.2)] mt-auto w-full">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="bg-[#F8F9FA] rounded-[2rem] p-8 flex flex-col items-center text-center relative h-64 border border-gray-100">
            <h3 className="text-xl md:text-2xl uppercase leading-tight mb-2 font-black text-center">
              ORCHESTRATE<br/>363 SKILLS
            </h3>
            <p className="text-[10px] md:text-xs text-black/60 font-bold mb-auto tracking-normal">
              High-fidelity intelligence mastery
            </p>
            ...
            <div className="relative w-full flex justify-center mt-6">
              <div className="flex items-center bg-[#0038FF] rounded-2xl p-2 pr-16 text-white shadow-lg relative z-10">
                ...
                <div className="text-left">
                  <p className="text-[10px] font-bold leading-none">sovereign.agent</p>
                  <p className="text-[8px] text-white/70 leading-none mt-1 uppercase tracking-tighter">Elite Rank Verified</p>
                </div>
              </div>
          ...
          <div className="bg-[#F8F9FA] rounded-[2rem] p-8 flex flex-col items-center text-center relative h-64 border border-gray-100">
            <h3 className="text-xl md:text-2xl uppercase leading-tight mb-2 font-black text-center">
              MASTER<br/>ALL DOMAINS
            </h3>
            <p className="text-[10px] md:text-xs text-black/60 font-bold mb-auto tracking-normal">
              Architectural integrity across 12 suites
            </p>
            
            <div className="relative w-full flex justify-center mt-6">
              <div className="flex items-center bg-[#0038FF] rounded-full p-1.5 text-white shadow-lg">
                <div className="bg-white/20 text-white font-bold text-sm px-4 py-2 rounded-full mr-2 leading-none flex items-center">
                  20.4220
                </div>
          ...
          <div className="bg-[#F8F9FA] rounded-[2rem] p-8 flex flex-col items-center text-center relative h-64 border border-gray-100">
            <h3 className="text-xl md:text-2xl uppercase leading-tight mb-2 font-black text-center">
              SOVEREIGN<br/>ORCHESTRATION
            </h3>
            <p className="text-[10px] md:text-xs text-black/60 font-bold mb-auto tracking-normal">
              Continuous agentic evolution
            </p>
            ...
            <div className="flex flex-col items-center bg-[#CCFF00] rounded-[2rem] px-6 py-4 text-black shadow-lg mt-6 relative w-full max-w-[200px]">
              <p className="text-[9px] font-bold uppercase tracking-wider mb-1">Total Skills Mastery</p>
              <p className="text-xl font-black">363 MODULES</p>
